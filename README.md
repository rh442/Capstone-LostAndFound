...
possible matches and collects structured ownership claims. Admins log
found items, review the claims, verify ownership over an in-app chat,
and authorize physical pickup. Students never see the found-item
inventory — verification is performed by humans (or deterministic
